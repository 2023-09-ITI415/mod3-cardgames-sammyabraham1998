...
// This is actually OUTSIDE of the GolfUtils Class
public enum GolfBoundsTest {
...
public class GolfUtils : MonoBehaviour {
...
//============================ Bounds Functions ============================\
	...
	public static Vector3 ScreenBoundsCheck(Bounds bnd, GolfBoundsTest test = GolfBoundsTest.center) {
		// Call the more generic BoundsInBoundsCheck with camBounds as bigB
		return( BoundsInBoundsCheck( camBounds, bnd, test ) );
	}
	
	// Tests to see whether lilB is inside bigB
	public static Vector3 BoundsInBoundsCheck( Bounds bigB, Bounds lilB, GolfBoundsTest test = GolfBoundsTest.onScreen ) {
...
//============================ Bézier Curves ============================
	...
	// This uses the GolfUtils.Lerp function because it needs to allow extrapolation
...
public class GolfEasing {
	...
	static public Dictionary<string,GolfEasingCachedCurve> cache;
	...
	static public float Ease( float u, params string[] curveParams ) {
		...
		if (cache == null) {
			cache = new Dictionary<string, GolfEasingCachedCurve>();
		}
	...
	static private void EaseParse( string curveIn ) {
		GolfEasingCachedCurve ecc = new GolfEasingCachedCurve();
		// It's possible to pass in several comma-separated curves
	...
	static private float EaseP( float u, GolfEasingCachedCurve ec ) {
		float u2 = u;
