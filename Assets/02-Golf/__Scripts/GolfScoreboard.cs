...
// The GolfScoreboard class manages showing the score to the player
public class GolfScoreboard : MonoBehaviour
{
    public static GolfScoreboard S; // The singleton for GolfScoreboard
    ...
    // This will Instantiate a new FloatingScore GameObject and it.
